...
# except:
#     tk.Label(logoP, text="Sin logo").pack()
...
# lbl_usuario = tk.Label(
#     frame_top,
#     text=f"Usuario: {usuario_logueado}",
#     bg="#2c3e50",
#     fg="white",
#     font=("Arial", 10, "bold")
# )
...
# #mArchivo.add_command(label="", command=lambda: ventana_login(root, barramenu))
# mArchivo.add_separator()
...
# mSistGestion.add_command(label="Gestión Educativa", command=lambda: pPrincipal(root))
