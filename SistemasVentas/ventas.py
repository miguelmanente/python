...
class Ventas(tk.Frame):
    ...
    def widgets(self):
        ...
        boton_agregar = tk.Button(lblframe1, text="Agregar Artículo",bg="#dddddd", font="sans 12 bold")
